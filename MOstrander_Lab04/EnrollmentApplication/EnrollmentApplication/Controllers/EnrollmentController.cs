...
namespace EnrollmentApplication.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,AssignedCampus,EnrollmentSemester,EnrollmentYear,IsActive,Notes")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,AssignedCampus,EnrollmentSemester,EnrollmentYear,IsActive,Notes")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
